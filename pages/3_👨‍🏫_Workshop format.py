...
st.markdown("""
    ...
    You will have **complete flexibility** to choose courses from Dataquest based on your personal learning goals and switch between 
    online self-study and supported in-person learning on-campus depending on your learning preferences and changing schedule.

    Each workshop is **one-hour** long, and you will work **with fellow learners**, utilising your **prior experience**, **web searches**, 
